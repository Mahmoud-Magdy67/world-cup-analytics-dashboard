...
if not tournament_stats.empty:
    # Merge tournament stats onto the full dataset for nation/club context when available
    ...
    st.warning("World Cup 2026 tournament statistics are not yet available. Showing club season stats below.")
